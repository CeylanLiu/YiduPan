        ...
        <template v-else>
            <div class="share-panel">
                ...
                <div class="share-op-btn">
                    ...
                    <el-button v-else type="primary" @click="save2MyPan"><span
                            class="iconfont icon-import" :disabled="selectFileIdList.length == 0"
                            ></span>保存到我的网盘</el-button>
                </div>
            </div>
            ...
            <div class="file-list">
                <Table ref="dataTableRef" :columns="columns" :showPagination="true" :dataSource="tableData"
                    :fetch="loadDataList" :initFetch="false" :options="tableOptions" :showPageSize="false"
                    ...
                    <template #fileName="{ row }">
                        <div class="file-item" @mouseenter="showOp(row)" @mouseleave="cancelShowOp(row)">
                            ...
                            <span class="op">
                                ...
                                <span v-if="row.showOp && !shareInfo.currentUser" class="iconfont icon-import"
